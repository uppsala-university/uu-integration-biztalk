...
Add-Type -Path "C:\Program Files\Service Bus\1.1\Microsoft.ServiceBus.dll"
...
$CurrentNamespace2 = Get-SBAuthorizationRule -namespace $Namespace
...
$NamespaceManager = [Microsoft.ServiceBus.NamespaceManager]::CreateFromConnectionString($CurrentNamespace2.ConnectionString);
