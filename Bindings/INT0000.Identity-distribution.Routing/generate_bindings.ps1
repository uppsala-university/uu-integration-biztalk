$DevBindings = 'INT0000.Identity-distribution.Routing.BindingInfo_Dev.xml'
$TestBindings = 'INT0000.Identity-distribution.Routing.BindingInfo_Test.xml'
$VerBindings = 'INT0000.Identity-distribution.Routing.BindingInfo_Ver.xml'
$ProdBindings = 'INT0000.Identity-distribution.Routing.BindingInfo_Prod.xml'
