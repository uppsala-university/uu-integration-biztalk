namespace INT0001.Ladok2.Events.Maps {
    ...
    public sealed class MembershipEventSingle_to_ForvantatDeltagandeSkapadEvent : global::Microsoft.XLANGs.BaseTypes.TransformBase {
...
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0 userCSharp"" version=""1.0"" xmlns:ns0=""http://schemas.ladok.se/studiedeltagande"" xmlns:events=""http://schemas.ladok.se/events"" xmlns:s0=""http://schemas.microsoft.com/Sql/2008/05/TypedPolling/ladokevents"" xmlns:dap=""http://schemas.ladok.se/dap"" xmlns:base=""http://schemas.ladok.se"" xmlns:userCSharp=""http://schemas.microsoft.com/BizTalk/2003/userCSharp"">
  ...
  <xsl:template match=""/s0:TypedPolling"">
    <xsl:variable name=""var:v1"" select=""userCSharp:StringConcat(string(s0:TypedPollingResultSet0/s0:TypedPollingResultSet0/s0:startSemester/text()) , &quot;_&quot; , string(s0:TypedPollingResultSet0/s0:TypedPollingResultSet0/s0:reportCode/text()))"" />
...
public string StringConcat(string param0, string param1, string param2)
{
   return param0 + param1 + param2;
        ...
        private const string _strTrgSchemasList0 = @"Shared.Schemas.Ladok.schemas_ladok_se_studiedeltagande+ForvantatDeltagandeSkapadEvent";
        
        private const global::Shared.Schemas.Ladok.schemas_ladok_se_studiedeltagande.ForvantatDeltagandeSkapadEvent _trgSchemaTypeReference0 = null;
        ...
        public override string[] TargetSchemas {
            get {
                ...
                _TrgSchemas[0] = @"Shared.Schemas.Ladok.schemas_ladok_se_studiedeltagande+ForvantatDeltagandeSkapadEvent";
                return _TrgSchemas;
            }
        }
    }
